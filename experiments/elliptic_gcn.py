#!/usr/bin/env python3
"""Elliptic Bitcoin fraud detection with GCN."""
...
def main():
    # Load config
    config_path = Path(__file__).parent.parent / "configs" / "elliptic_gcn.yaml"
    ...
    # Training loop
    print(f"\nTraining GCN for {config.training.epochs} epochs...")
    best_test_acc = 0.0
